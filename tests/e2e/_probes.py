...
MATRIX = [
    ...
    ("M14", "single_point", "ee", "pyscf", 2,
     {"method": "dft", "basis": "sto-3g", "n_excited_states": 5, "functional": "b3lyp"},
     "method=dft must make `functional` required and elicited"),
    ("M15", "single_point", "ee", "orca",  2,
     {"method": "hf", "basis": "sto-3g", "n_excited_states": 5}, ""),
    ("M16", "single_point", "ee", "orca",  2,
     {"method": "eom_ccsd", "basis": "sto-3g", "n_excited_states": 3},
    ...
    ("M30", "single_point", "nac", "orca", 2,
     {"method": "dft", "basis": "sto-3g", "functional": "pbe0", "n_excited_states": 3, "state_pairs": [[1, 2]]},
