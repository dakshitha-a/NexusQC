...
The three most recent closures:

- [`trackers/2026-08-streamlining-agent-turns.md`](trackers/2026-08-streamlining-agent-turns.md)
  a sweep of every path that starts an agent turn, removing the three whose
  entire output was narration of something the app already held, plus the
  prompt-shape cliff that made long conversations slow. 30 steps across six
