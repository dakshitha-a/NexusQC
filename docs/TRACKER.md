...
- [`trackers/2026-08-manuscript-evaluation-battery.md`](trackers/2026-08-manuscript-evaluation-battery.md)
  running the evaluation the RSC Digital Discovery draft promises. Closed
  2026-08-25 with the run recorded but not every row green; its results live in
  `rsc_digital_discovery/evaluation/`.
