...
**Complete as of 2026-09-09. Two phases, seven steps, both merged.**
Archived 2026-09-10 when the installer audit opened.

Two phases. Gives the job label back the
...
[`2026-09-brand-mark-theming-and-ui-pass.md`](2026-09-brand-mark-theming-and-ui-pass.md);
the one that replaced it is
[`2026-09-installer-audit.md`](../TRACKER.md), still active at the time of
archiving.
...
- merged: 99f3f8fddd19f42a0d02567c75657fc4b8cbfdd7
