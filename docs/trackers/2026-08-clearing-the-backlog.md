...
Two steps were closed by *removal* rather than completion -- the public
listener and the kill switch built to control it -- and two were carried
forward rather than marked done: P7.1 and P7.2, the battery re-runs, which
need an audit of the task cards first. That audit is in `BACKLOG.md`.
