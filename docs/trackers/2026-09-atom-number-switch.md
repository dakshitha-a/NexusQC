# Closed Tracker: one switch for the atom numbers, in every viewer and every export
...
Closed 2026-09-02 and archived here when the CAS active-space recommendation
rebuild became the active plan. **Exactly one tracker is active at a time.**
