# Closed Tracker: clearing the backlog, round 2

**Closed 2026-08-29. Thirteen steps across seven phases, all done.** The second
plan to carry this name: the first ran to 2026-08-26 and is
[`2026-08-clearing-the-backlog.md`](2026-08-clearing-the-backlog.md). This one
took the seven items left open in `BACKLOG.md` afterwards, closed six of them,
and established that the seventh (perf_02's concurrency budget) was measuring
the host rather than the app.

Superseded as the active tracker by the NEVPT2/MC-PDFT/L-PDFT plan.
