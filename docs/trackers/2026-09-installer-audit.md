# Closed Tracker: the installer, audited
...
Archived on 2026-09-11 when the app-review plan opened. **Exactly one tracker
is active at a time.** The one this replaced is
[`2026-09-job-row-width-and-stop-control.md`](2026-09-job-row-width-and-stop-control.md);
the one that replaced it is the app review, `docs/TRACKER.md`.
...
- merged: 1b53214f49dc1198d45fc472304144ec3afc6161
