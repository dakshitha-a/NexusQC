...
| `single_point/ee` | `want_oscillator_strengths` | `False` | Keeps PySCF out of the running, which cannot compute them for CASSCF. ORCA and BAGEL both can; ORCA wins on preference order unless BAGEL is named |
